...
if section == "Prediction":
    ...
    - **Machine Learning Model**: The primary model used is the **Random Forest Regressor**, which provides an impressive **92% accuracy**. Random Forest was chosen for its robustness in handling complex, non-linear data. In addition, a **K-Nearest Neighbors (KNN)** model was also tested, achieving a **90% accuracy**, but Random Forest was selected for better overall performance.
